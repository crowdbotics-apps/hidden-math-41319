"""
Django settings for hidden_math_41319 project.
...
ROOT_URLCONF = 'hidden_math_41319.urls'
...
WSGI_APPLICATION = 'hidden_math_41319.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_math_41319 API",
    "DESCRIPTION": "API documentation for hidden_math_41319 App",
    "VERSION": "v1",
}
